...
async function main() {
  ...
  const sessionsData = [
    ...
    { username: "typemaster", mode: "code", grossWpm: 90, netWpm: 88, accuracy: 97.8, timeTakenSeconds: 33.3, charsTyped: 250, mistakes: 2 },
    ...
    { username: "code_runner", mode: "code", grossWpm: 105, netWpm: 102, accuracy: 97.1, timeTakenSeconds: 28.5, charsTyped: 250, mistakes: 3 },
